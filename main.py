...
link = "http://test.mymxp.com/cgi-bin/MarineXchangeEComWebService2.exe/wsdl/IMarineXchangeECommerce"
client = Client(link)
...
@app.get("/get_po/")
async def get_purchase_order(pocode:str, username:str):
    return {
        "POHeader": client.service.GetPOHeader(pocode, username),
        "PODetails": client.service.GetPODetails(pocode)
    }
